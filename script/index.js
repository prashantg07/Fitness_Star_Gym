...
function submitForm() {
  ...
  let personalTraining = document.querySelector(
    'input[name="personal-training"]:checked'
  );
  ...
  if (
    ...
    alert(
      "Please fill in all the required fields and accept the terms and conditions before submitting the form."
    );
    return;
  }

  alert(
    "Thank you, " + fullName + "! Your form has been submitted successfully."
  );
  closeRegisterForm();
}
...
images[4] = "../images/pexels-leon.jpg";
